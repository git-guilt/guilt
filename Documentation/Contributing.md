There's not much to helping develop Guilt.
...
2) Describe the changes:
	...
	Make sure the pull request or git commit message contains a good description
	of the changes.

3) Make a pull request:

	Follow GitHub documentation at [[1]] or [[2]].
...
[2]: https://github.blog/developer-skills/github/beginners-guide-to-github-creating-a-pull-request/
